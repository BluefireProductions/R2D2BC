...
import { UserProperties, UserProperty } from "./UserProperties";
...
export declare class UserSettings implements IUserSettings {
    ...
    protected constructor(store: Store, headerMenu: HTMLElement, api: NavigatorAPI, injectables: Array<Injectable>, layout: string);
    stop(): Promise<void>;
    private initialise;
    private reset;
    ...
    applyUserSettings(userSettings: UserSettings): Promise<void>;
    /**
    ...
    increase(incremental: any): Promise<void>;
