    ...
    constructor() {
        ...
        this.setupEvents = (element) => {
            ...
            element.addEventListener("touchend", function (event) {
                ...
                if (Math.abs(xDevicePixels) < TouchEventHandler.TAP_TOLERANCE &&
                    ...
                    if (event.timeStamp - touchEventStart.timeStamp >
...
TouchEventHandler.TAP_TOLERANCE = 10;
TouchEventHandler.LONG_PRESS_MS = 500;
TouchEventHandler.SLOW_SWIPE_MS = 500;
